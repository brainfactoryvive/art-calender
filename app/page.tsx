...
export default function Home() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "브레인팩토리 한예종디자인전문학원/미술원 전문관의 2026 한예종 디자인 1차 합격작과 최종 합격작들은 단순 유행 스타일 암기를 배제하고, 출제의 본질을 꿰뚫는 공간 연출과 문제 해석력에 포커싱했습니다. 한예종 전문학원의 차별화된 합격작 정밀 분석 결과는 학생들의 개인별 일간 크리틱 데이터베이스와 캘린더에 고스란히 연계 연동됩니다."
    },
    {
      q: "한예종 무대전문학원 및 멀티영상학원 전형 대비와 디자인후기/합격작 확인은 어디서 하나요?",
      a: "한예종 무대전문학원 및 한예종 멀티영상학원 전형을 집중 대비하는 미대 입시생들을 위해, 무대미술과 및 멀티미디어영상과 합격생들의 리얼 한예종 디자인후기 아카이브와 2026 한예종 합격작 포트폴리오 열람을 제공합니다. 본 통합 캘린더 시스템은 1차 실기고사 일정부터 2차 구술 및 심층 실기 루틴까지 학생 개별 템포에 맞춰 밀착 제어합니다."
    },
    {
